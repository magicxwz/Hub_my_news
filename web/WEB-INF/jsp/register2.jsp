		...
		<FORM action="" method="post" name="myform">
			<TABLE border="0" cellpadding="0" cellspacing="0" align="center">
				...
				<TR>
					...
					<TD width="524">
						<INPUT name="txtUser" type="text" maxlength="16">
						只能输入字母或数字，4-16个字符
					</TD>
				</TR>
				<TR>
				...
				<TR>
					...
					<TD width="524">
						<INPUT name="txtRPass" type="password">
					</TD>
				</TR>
				<TR>
					<TD width="107" height="36">
				...
				<TR>
					...
					<TD width="524">
						<input type="checkbox" name="habby" value="体育">
						体育&nbsp;
						<input type="checkbox" name="habby" value="读书">
						读书&nbsp;
						<input type="checkbox" name="habby" value="音乐">
						音乐&nbsp;
						<input type="checkbox" name="habby" value="旅游">
						旅游&nbsp;
					</TD>
				</TR>
				<TR>
					...
					<TD width="524">
						<INPUT name="year" id="year" size=4 maxlength=4>
						&nbsp;年&nbsp;&nbsp;
						<SELECT name="month">
							<OPTION value=1>
								一月
