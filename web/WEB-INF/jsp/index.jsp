    ...
    <div id="container">
        ...
        <div class="main">
            ...
            <div class="content">
                <ul class="class_date">
                    <li id="class_month">
                        <c:forEach items="${news}" var="newx" begin="0" end="10">
                            <a href='index1.jsp?ntid=1'><b>${newx.topics.tname}</b></a>
                        </c:forEach>
                    </li><li id="class_month">
                        <c:forEach items="${news}" var="newx" begin="11" end="20">
                            <a href='index1.jsp?ntid=1'><b>${topic.topics.tname}</b></a>
                        </c:forEach>
                </li>
                </ul>
                <ul class="classlist">
                    ...
                    <li class="space"></li>
                    <c:forEach items="${news}" var="newx" begin="20" end="14">
                        <li><a href="#">${newx.ntitle}</a><span>(<fmt:formatDate pattern="yyyy-MM-dd HH:mm" value="${newx.ncreateDate}" />)</span></li>
                    </c:forEach>
                    <li class="space"></li>
                </ul>
